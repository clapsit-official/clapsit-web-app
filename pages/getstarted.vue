  ...
  <div id="get-started-page">
    ...
    <section id="form-area" class="flex-row-center">
      <div
        ...
        v-if="$router.currentRoute.value.query['view'] === 'login'"
      >
        <div
          id="logo-area-mobile"
          class="flex-row-center"
          v-if="showLogoForMobile"
        >
          <logo size="70%" type="2" />
        </div>
        <forms-login />
      ...
      <div
        id="register"
        class="static-container"
        v-else-if="$router.currentRoute.value.query['view'] === 'register'"
      >
        <div
          id="logo-area-mobile"
          class="flex-row-center"
      ...
      <div
        ...
        class="static-container"
        v-else-if="
          $router.currentRoute.value.query['view'] === 'forgot_password'
        "
      >
        <div
          id="logo-area-mobile"
